            ...
            children: [
              ...
              Expanded(child: Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  10.heightBox,
                  "This is a dummy item and dummy description here...".text.color(textfieldGrey).make(),
                    ...
                    child: Row(
                      children: List.generate(6, (index) => Column(
                        ...
                        children: [
                          ...
                          width: 130,
                          fit: BoxFit.cover ,),
                          "1000 Watt Mixer grinder".text.fontFamily(semibold).color(darkFontGrey).make(),

                          10.heightBox,
                          "\$700".text.color(redColor)
                          .fontFamily(bold).size(16).make(),
                        ],
                      ).box.white.margin(const EdgeInsets.symmetric(horizontal: 4)).roundedSM
                      .padding(const EdgeInsets.all(8))
                      .make(),
                      ),
                    ),
